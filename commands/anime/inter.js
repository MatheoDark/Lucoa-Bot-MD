...
const captions = {
  ...
  cheekkiss: (from, to) => from === to ? 'se dio un beso en la mejilla.' : 'le dio un beso en la mejilla a',
  embarazo: (from, to) => from === to ? 'se imagina una familia anime.' : 'le dio vibes de futuro bebé anime a',
...
const commandAliases = {
  ...
  pensar: 'think',
  besito: 'peck',
  besomejilla: 'cheekkiss',
  besodemejilla: 'cheekkiss',
  embarazar: 'embarazo',
  preñar: 'embarazo',
  ...
  run: async ({ client, m }) => {
    ...
    try {
      ...
      const fetchFromTenor = async (cmd) => {
        const tenorQueryMap = {
          kiss: ['anime kiss', 'anime kiss reaction', 'anime couple kiss'],
          hug: ['anime hug', 'anime embrace', 'anime cuddle'],
          pat: ['anime pat', 'anime head pat', 'anime pet'],
          poke: ['anime poke', 'anime finger poke'],
          slap: ['anime slap', 'anime smack', 'anime hit'],
          bite: ['anime bite', 'anime bite reaction', 'anime bite cute'],
          punch: ['anime punch', 'anime fight punch', 'anime hit punch'],
          kickanime: ['anime kick', 'anime kick reaction', 'anime fight kick'],
          kill: ['anime kill', 'anime attack', 'anime punch', 'anime sword'],
          cuddle: ['anime cuddle', 'anime snuggle', 'anime embrace'],
          dance: ['anime dance', 'anime dancing', 'anime happy dance'],
          run: ['anime run', 'anime running', 'anime sprint'],
          wave: ['anime wave', 'anime hello', 'anime greeting'],
          smile: ['anime smile', 'anime happy smile', 'anime grin'],
          wink: ['anime wink', 'anime teasing wink', 'anime flirty wink'],
          blush: ['anime blush', 'anime embarrassed', 'anime shy blush'],
          cry: ['anime cry', 'anime crying', 'anime tears'],
          eat: ['anime eat', 'anime eating', 'anime snack'],
          tickle: ['anime tickle', 'anime teasing', 'anime playful tickle'],
          feed: ['anime feed', 'anime feeding', 'anime offering food'],
          meow: ['anime meow', 'anime neko', 'anime cat girl'],
          neko: ['anime neko', 'anime cat girl', 'anime tail'],
          lizard: ['anime lizard', 'anime gecko', 'anime reptile'],
          woof: ['anime dog', 'anime woof', 'anime puppy'],
          fox_girl: ['anime fox girl', 'anime kitsune', 'anime tail girl'],
          smug: ['anime smug', 'anime smug smile', 'anime confident'],
          lewd: ['anime lewd', 'anime flirty', 'anime teasing'],
          spank: ['anime spank', 'anime slap', 'anime smack'],
          gasm: ['anime gasp', 'anime excited', 'anime shocked'],
          gecko: ['anime gecko', 'anime lizard', 'anime reptile'],
          angry: ['anime angry', 'anime mad', 'anime furious'],
          fluff: ['anime fluffy', 'anime fluffy tail', 'anime soft'],
          lick: ['anime lick', 'anime teasing lick', 'anime tongue'],
          pout: ['anime pout', 'anime grumpy', 'anime annoyed'],
          tail: ['anime tail', 'anime wag tail', 'anime fox tail'],
          comfy: ['anime comfy', 'anime relaxed', 'anime cozy'],
          highfive: ['anime high five', 'anime highfive', 'anime celebration'],
          handhold: ['anime handhold', 'anime holding hands', 'anime couple hands'],
          nom: ['anime nom', 'anime bite snack', 'anime eating'],
          laugh: ['anime laugh', 'anime laughing', 'anime giggle'],
          yeet: ['anime yeet', 'anime throw', 'anime toss'],
          shrug: ['anime shrug', 'anime confused shrug', 'anime whatever'],
          stare: ['anime stare', 'anime serious stare', 'anime eye contact'],
          think: ['anime think', 'anime thinking', 'anime pondering'],
          peck: ['anime peck', 'anime kiss peck', 'anime small kiss'],
          cheekkiss: ['anime cheek kiss', 'anime cheek kiss reaction', 'anime kiss on cheek'],
          embarazo: ['anime pregnant', 'anime baby bump', 'anime family'],
          bite_head: ['anime bite', 'anime head bite', 'anime attack bite'],
          bleh: ['anime bleh', 'anime tongue out', 'anime teasing'],
          bonk: ['anime bonk', 'anime hit head', 'anime bop'],
          bored: ['anime bored', 'anime sleepy bored', 'anime uninterested'],
          bully: ['anime bully', 'anime teasing bully', 'anime mean'],
          celebrate: ['anime celebrate', 'anime party', 'anime cheers'],
          clap: ['anime clap', 'anime applauding', 'anime cheering'],
          coffee: ['anime coffee', 'anime drinking coffee', 'anime cafe'],
          comfort: ['anime comfort', 'anime console', 'anime hug comfort'],
          confused: ['anime confused', 'anime confused face', 'anime question'],
          cringe: ['anime cringe', 'anime embarrassed cringe', 'anime awkward'],
          dramatic: ['anime dramatic', 'anime drama', 'anime overreact'],
          drunk: ['anime drunk', 'anime tipsy', 'anime alcohol'],
          flick: ['anime flick', 'anime hair flick', 'anime snap'],
          freeze: ['anime freeze', 'anime shocked freeze', 'anime frozen'],
          grab: ['anime grab', 'anime hold', 'anime catch'],
          happy: ['anime happy', 'anime joyful', 'anime excited'],
          impregnate: ['anime seduce', 'anime flirt', 'anime romantic'],
          knead: ['anime knead', 'anime massage', 'anime petting'],
          love: ['anime love', 'anime heart', 'anime affectionate'],
          sad: ['anime sad', 'anime crying', 'anime depressed'],
          scared: ['anime scared', 'anime fear', 'anime frightened'],
          seduce: ['anime seduce', 'anime flirt', 'anime wink'],
          shock: ['anime shock', 'anime surprised', 'anime stunned'],
          shy: ['anime shy', 'anime embarrassed', 'anime blushing'],
          sing: ['anime sing', 'anime singing', 'anime karaoke'],
          sleep: ['anime sleep', 'anime sleeping', 'anime nap'],
          slurp: ['anime slurp', 'anime lick', 'anime eating'],
